 ...
 */
#ifndef PEVAL_OMAHAHIGHHANDEVALUATORONLYFLOP_H_
#define PEVAL_OMAHAHIGHHANDEVALUATORONLYFLOP_H_
 ...
 */
class OmahaHighHandEvaluatorOnlyFlop : public PokerHandEvaluator
{
public:
    static const int NUM_OMAHA_POCKET = 4;
    static const int NUM_OMAHA_FLOP = 1;
    static const int NUM_OMAHA_RIVER = 3;
...
#endif  // PEVAL_OMAHAHIGHHANDEVALUATORONLYFLOP_H_
